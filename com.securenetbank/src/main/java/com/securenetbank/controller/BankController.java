...
public class BankController {
    ...
    public String transactions(HttpSession session, Model model) {
        String currentAccount = (String) session.getAttribute("currentAccount"); // account number
        if (currentAccount == null) return "redirect:/login";

        model.addAttribute("transactions", accountService.getTransactionsForUser(currentAccount));
